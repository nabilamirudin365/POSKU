...
public class AppDbContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder mb)
    {
        ...
        // Purchase
        mb.Entity<PurchaseHeader>().HasIndex(h => h.Number).IsUnique();
        mb.Entity<PurchaseItem>().Property(i => i.Cost).HasPrecision(18, 2);
        mb.Entity<PurchaseItem>().Property(i => i.LineTotal).HasPrecision(18, 2);
    }
}
